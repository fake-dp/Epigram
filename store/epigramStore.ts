...
const dummyEpigrams: Epigram[] = [
    {
      ...
      writerId: 301,
      referenceUrl: "https://example.com/epigram1",
    ...
    },
    {
      ...
      writerId: 302,
      referenceUrl: "https://example.com/epigram2",
    ...
    },
    {
      ...
      writerId: 303,
      referenceUrl: "https://example.com/epigram3",
    ...
    },
    {
      ...
      writerId: 304,
      referenceUrl: "https://example.com/epigram4",
      referenceTitle: "사랑의 정의",
      author: "작가 4",
      content: "사랑은 서로 다른 두 마음이 하나로 연결되는 순간에 완성된다.",
    },
    {
      id: 5,
      likeCount: 25,
      ...
      writerId: 305,
      referenceUrl: "https://example.com/epigram5",
    ...
    },
    {
      ...
      writerId: 306,
      referenceUrl: "https://example.com/epigram6",
